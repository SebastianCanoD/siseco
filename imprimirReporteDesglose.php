...
// Construir la cláusula WHERE para Reporte Fiscal
$where = "WHERE 1=1 ";
...
// Aquí se excluyen las obras que tengan el patrón de Informe de Gobierno
...
<body>
  ...
  <div class="data-header">
    <h1>DESGLOSE PARA REPORTE FISCAL POR DEPENDENCIA</h1>
...
$dompdf->render();
$dompdf->stream("Reporte_Desglose.pdf", ['Attachment' => false]);
?>