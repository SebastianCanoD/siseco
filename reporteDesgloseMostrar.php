...
/*
  Se reciben los filtros enviados desde el formulario (por GET):
...
if (!empty($ejercicio_fiscal)) {
  // Usamos el valor ingresado para el ejercicio fiscal
  $yearSafe = mysqli_real_escape_string($conn, $ejercicio_fiscal);
  $prev = $yearSafe - 1;
  // Para Ejercicio Fiscal se requiere que la obra:
  // - Sea del año ingresado,
  // - Tenga en tipo_destino 'EJERCICIO_FISCAL' o 'AMBOS'
  // - Y NO presente el patrón exacto de Informe de Gobierno (fechas: inicio = 16 de octubre del año previo, término = 15 de octubre del año buscado)
...
/* Consulta resumen:
   - Cuenta de obras,
   - Suma de las inversiones programadas y ejercidas,
   - Promedio de avance físico y financiero.
*/
$summarySql = "SELECT 
...
/* Consulta detalle:
   Se unen obra con inversión y otras tablas para obtener el desglose de obras.
...
<!-- Aquí iría la presentación de los resultados (resumen y detalle) según tus requerimientos -->
...
<div class="container mt-4">
  ...
  <div class="card text-white" style="background-color: #8B4513;">
    <div class="card-body">
      <h1 class="card-title text-center mb-0">DESGLOSE DE OBRAS PARA EJERCICIO FISCAL POR DEPENDENCIA</h1>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="text-center my-4">
        <a href="imprimirReporteDesglose.php?dependencia=<?php echo urlencode($dependencia); ?>&ejercicio_fiscal=<?php echo urlencode($ejercicio_fiscal); ?>"
