...
// Consulta para obtener las dependencias segun el usuario
if ($nivel_usuario == 1) {
    ...
    // Capturista: obtiene solamente la dependencia asignada al usuario
...
<div class="container mt-4">
    <h1 class="mb-4">Reporte por ejercicio fiscal: Resumen</h1>
    <form action="reporteResumenMostrar.php" method="GET">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <?php else: 
                                // Para capturistas, mostramos la dependencia asignada
                                $dep = mysqli_fetch_assoc($resDep);
                                $depNombre = $dep['nombre'] ?? '';
                        ?>
                            <!-- Enviamos la dependencia mediante un campo oculto y mostramos el nombre en texto -->
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="ejercicio_fiscal" name="ejercicio_fiscal" required>
                            ...
                            <!-- Opciones de año; puedes personalizarlas o llenarlas dinámicamente -->
