...
<head>
  <meta charset="UTF-8">
  <title>Detalle Obra ' . htmlspecialchars($obra['id_obra']) . '</title>
<style>
...
$displayInvestmentRow("Programada", "inversion_programada_", $d, $html);
$displayInvestmentRow("Autorizada", "inversion_autorizada_", $d, $html);
