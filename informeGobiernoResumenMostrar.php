...
// Recibimos los filtros vía GET (puedes alternar con POST)
...
// Se cuentan las obras, se suma el total programado, el total modificado y ejercido; se obtienen además promedios de avances.
$summarySql = "SELECT 
    ...
    -- Cálculo ponderado del avance físico:
...
// Para las gráficas se calcularán los porcentajes de inversión modificada y ejercida sobre el total programado.
...
// Se agrupa por programa (usando la unión con programa_inversion) para obtener el desglose.
$detailSql = "SELECT 
...
<div class="container mt-4">
  <div class="card text-white" style="background-color: #8B4513;">
    <div class="card-body">
      <h1 class="card-title text-center mb-0">RESUMEN PARA INFORME DE GOBIERNO POR DEPENDENCIA</h1>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="text-center my-4">
        <a href="imprimirInformeResumen.php?dependencia=<?php echo urlencode($dependencia); ?>&ejercicio_fiscal=<?php echo urlencode($ejercicio_fiscal); ?>"
