...
// Consulta para obtener las dependencias según el usuario
if ($nivel_usuario == 1) {
    ...
    // Capturista: obtiene sólo la dependencia asignada
...
<div class="container mt-4">
    <h1 class="mb-4">Anexo de Inversión: Informe de Gobierno por Resumen</h1>
    <form action="informeGobiernoResumenMostrar.php" method="GET">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <?php else: 
                                // Para capturistas, mostramos solamente la dependencia asignada
                                $dep = mysqli_fetch_assoc($resDep);
                                $depNombre = $dep['nombre'] ?? '';
                        ?>
                            <!-- Enviamos la dependencia mediante un campo oculto -->
